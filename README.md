...
- On linux_master server terminal use following codes:
  ...
  - ls -ltr kubertnetes/ | shows whats inside each folder
    - tasks: contains yaml of all task you would wrint in playbook
    - meta: what the playbook is doing
    - defaults: stores variables
    - vars: store variables
    - tests: add unit test for python, shell, etc
    - handlers: handles exceptions
    - read.me: content
    - files: files used in project
    - templates: used template
